...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!isMediaMessage) {
        ...
        //if ([UIDevice jsq_isCurrentDeviceBeforeiOS8]) {
            ...
            cell.textView.attributedText =  [collectionView.dataSource collectionView:collectionView attributedTextForTextViewAtIndexPath:indexPath];
...
//            //cell.messageBubbleImageView.layer.cornerRadius = 10.0f;
//            //[cell.messageBubbleImageView setBackgroundColor:[UIColor purpleColor]];
...
- (void)jsq_setCollectionViewInsetsTopValue:(CGFloat)top bottomValue:(CGFloat)bottom
{
    // Fix #487 (temporary): set top = 0.0f;
