                       ...
                       groupName:(NSString *)groupName
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date groupName:groupName isMedia:NO];
    if (self) {
        _text = [text copy];
    }
    return self;
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        _groupName = [aDecoder decodeObjectForKey:NSStringFromSelector(@selector(groupName))];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.groupName forKey:NSStringFromSelector(@selector(groupName))];
